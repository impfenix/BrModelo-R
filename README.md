...
<div align="center">
  <img src="print.png" alt="BrModelo-R" width="100%" />
</div>

## 🚀 Funcionalidades

- **App de Modelagem**: Ferramenta iterativa focada em diagramas Lógico e Conceitual (MER/DER) baseados na notação do brModelo.
  - _Nota:_ Os componentes de UML, topologia de rede e planta baixa encontram-se ocultos na interface, porém **estão parcialmente implementados e não indisponíveis para uso**, pendentes de criação dos modelos e conectores para desenho (veja [CONTRIBUTING.md](CONTRIBUTING.md) caso deseje contribuir).
